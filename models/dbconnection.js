...
const url = 'mongodb+srv://' + ('cse180001061' || process.env.MongoUser) + ':' + (process.env.MongoPass || 'katewa110023') + '@test-cluster-t8qxz.mongodb.net/Slabber?retryWrites=true&w=majority';
